  ...
  return <div className="relative min-h-screen">
      ...
      <div className="absolute top-8 w-full flex justify-between px-8 text-sm">
        ...
        <div className="flex items-center gap-4">
          <a href="mailto:tharungadupudi@gmail.com" className="flex items-center gap-2 bg-[#f5f5f4] hover:bg-[#e7e5e4] transition-colors px-3 py-1.5 rounded-full text-[#1c1917]">
            <Mail className="w-4 h-4" />
            tharungadupudi@gmail.com
          </a>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
        ...
        <p className="text-xl mb-8 max-w-2xl">Web developer, designer, pet lover, and adventure seeker – that's me!</p>

        {/* Profile Image */}
        <div className="w-48 h-48 rounded-full overflow-hidden mb-8 border-4 border-primary/20">
          <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158" alt="Tharun's profile" className="w-full h-full object-cover" />
        </div>
